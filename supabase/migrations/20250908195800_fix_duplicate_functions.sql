-- Drop all existing temporary reservation functions to avoid conflicts
DROP FUNCTION IF EXISTS public.create_temporary_reservation(uuid, date, time without time zone, time without time zone, uuid, integer);
DROP FUNCTION IF EXISTS public.create_temporary_reservation(uuid, date, time without time zone, time without time zone, integer, uuid);
DROP FUNCTION IF EXISTS public.update_temporary_to_permanent(uuid, uuid);
DROP FUNCTION IF EXISTS public.release_temporary_reservation(uuid);
DROP FUNCTION IF EXISTS public.is_time_slot_available(uuid, timestamptz, integer);

-- Create the correct create_temporary_reservation function
...
-- Create the update_temporary_to_permanent function
...
-- Create the release_temporary_reservation function
...
-- Create the is_time_slot_available function
