-- Add mobile_number column back to profiles table
ALTER TABLE public.profiles ADD COLUMN mobile_number text;

-- Update the handle_new_user trigger function to include mobile_number
...
-- Add comment to the mobile_number column
COMMENT ON COLUMN public.profiles.mobile_number IS 'User mobile phone number';
